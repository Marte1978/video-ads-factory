"""
render_batch21.py -- Renderiza los 10 videos del Batch 21 (copies 201-210).
...
VIDEOS = [
    {"n": "201", "id": "BioScan201", "voz": "es-CO-GonzaloNeural"},
    {"n": "202", "id": "BioScan202", "voz": "es-MX-JorgeNeural"},
    {"n": "203", "id": "BioScan203", "voz": "es-ES-AlvaroNeural"},
    {"n": "204", "id": "BioScan204", "voz": "es-CL-LorenzoNeural"},
    {"n": "205", "id": "BioScan205", "voz": "es-CO-GonzaloNeural"},
    {"n": "206", "id": "BioScan206", "voz": "es-MX-JorgeNeural"},
    {"n": "207", "id": "BioScan207", "voz": "es-ES-AlvaroNeural"},
    {"n": "208", "id": "BioScan208", "voz": "es-CL-LorenzoNeural"},
    {"n": "209", "id": "BioScan209", "voz": "es-CO-GonzaloNeural"},
    {"n": "210", "id": "BioScan210", "voz": "es-MX-JorgeNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch21.py")])
    if rc != 0:
...
log(f"\n=== BATCH 21 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 21 completo. Revisa D:\\500 videos bioscan\\")
