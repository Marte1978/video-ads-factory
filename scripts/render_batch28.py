"""
render_batch28.py -- Renderiza los 10 videos del Batch 28 (copies 271-280).
...
VIDEOS = [
    {"n": "271", "id": "BioScan271", "voz": "es-ES-AlvaroNeural"},
    {"n": "272", "id": "BioScan272", "voz": "es-CL-LorenzoNeural"},
    {"n": "273", "id": "BioScan273", "voz": "es-CO-GonzaloNeural"},
    {"n": "274", "id": "BioScan274", "voz": "es-MX-JorgeNeural"},
    {"n": "275", "id": "BioScan275", "voz": "es-ES-AlvaroNeural"},
    {"n": "276", "id": "BioScan276", "voz": "es-CL-LorenzoNeural"},
    {"n": "277", "id": "BioScan277", "voz": "es-CO-GonzaloNeural"},
    {"n": "278", "id": "BioScan278", "voz": "es-MX-JorgeNeural"},
    {"n": "279", "id": "BioScan279", "voz": "es-ES-AlvaroNeural"},
    {"n": "280", "id": "BioScan280", "voz": "es-CL-LorenzoNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch28.py")])
    if rc != 0:
...
log(f"\n=== BATCH 28 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 28 completo. Revisa D:\\500 videos bioscan\\")
