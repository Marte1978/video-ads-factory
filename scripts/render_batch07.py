"""
render_batch07.py -- Renderiza los 10 videos del Batch 07 (copies 061-070).
...
VIDEOS = [
    {"n": "061", "id": "BioScan061", "voz": "es-CL-LorenzoNeural"},
    {"n": "062", "id": "BioScan062", "voz": "es-MX-JorgeNeural"},
    {"n": "063", "id": "BioScan063", "voz": "es-CO-GonzaloNeural"},
    {"n": "064", "id": "BioScan064", "voz": "es-ES-AlvaroNeural"},
    {"n": "065", "id": "BioScan065", "voz": "es-CL-LorenzoNeural"},
    {"n": "066", "id": "BioScan066", "voz": "es-MX-JorgeNeural"},
    {"n": "067", "id": "BioScan067", "voz": "es-CO-GonzaloNeural"},
    {"n": "068", "id": "BioScan068", "voz": "es-ES-AlvaroNeural"},
    {"n": "069", "id": "BioScan069", "voz": "es-CL-LorenzoNeural"},
    {"n": "070", "id": "BioScan070", "voz": "es-MX-JorgeNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch07.py")])
    if rc != 0:
...
log(f"\n=== BATCH 07 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 07 completo. Revisa D:\\500 videos bioscan\\")
