"""
render_batch27.py -- Renderiza los 10 videos del Batch 27 (copies 261-270).
...
VIDEOS = [
    {"n": "261", "id": "BioScan261", "voz": "es-CO-GonzaloNeural"},
    {"n": "262", "id": "BioScan262", "voz": "es-MX-JorgeNeural"},
    {"n": "263", "id": "BioScan263", "voz": "es-ES-AlvaroNeural"},
    {"n": "264", "id": "BioScan264", "voz": "es-CL-LorenzoNeural"},
    {"n": "265", "id": "BioScan265", "voz": "es-CO-GonzaloNeural"},
    {"n": "266", "id": "BioScan266", "voz": "es-MX-JorgeNeural"},
    {"n": "267", "id": "BioScan267", "voz": "es-ES-AlvaroNeural"},
    {"n": "268", "id": "BioScan268", "voz": "es-CL-LorenzoNeural"},
    {"n": "269", "id": "BioScan269", "voz": "es-CO-GonzaloNeural"},
    {"n": "270", "id": "BioScan270", "voz": "es-MX-JorgeNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch27.py")])
    if rc != 0:
...
log(f"\n=== BATCH 27 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 27 completo. Revisa D:\\500 videos bioscan\\")
