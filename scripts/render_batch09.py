"""
render_batch09.py -- Renderiza los 10 videos del Batch 09 (copies 081-090).
...
VIDEOS = [
    {"n": "081", "id": "BioScan081", "voz": "es-CO-GonzaloNeural"},
    {"n": "082", "id": "BioScan082", "voz": "es-MX-JorgeNeural"},
    {"n": "083", "id": "BioScan083", "voz": "es-ES-AlvaroNeural"},
    {"n": "084", "id": "BioScan084", "voz": "es-CL-LorenzoNeural"},
    {"n": "085", "id": "BioScan085", "voz": "es-CO-GonzaloNeural"},
    {"n": "086", "id": "BioScan086", "voz": "es-MX-JorgeNeural"},
    {"n": "087", "id": "BioScan087", "voz": "es-ES-AlvaroNeural"},
    {"n": "088", "id": "BioScan088", "voz": "es-CL-LorenzoNeural"},
    {"n": "089", "id": "BioScan089", "voz": "es-CO-GonzaloNeural"},
    {"n": "090", "id": "BioScan090", "voz": "es-MX-JorgeNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch09.py")])
    if rc != 0:
...
log(f"\n=== BATCH 09 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 09 completo. Revisa D:\\500 videos bioscan\\")
