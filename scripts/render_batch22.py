"""
render_batch22.py -- Renderiza los 10 videos del Batch 22 (copies 211-220).
...
VIDEOS = [
    {"n": "211", "id": "BioScan211", "voz": "es-ES-AlvaroNeural"},
    {"n": "212", "id": "BioScan212", "voz": "es-CL-LorenzoNeural"},
    {"n": "213", "id": "BioScan213", "voz": "es-CO-GonzaloNeural"},
    {"n": "214", "id": "BioScan214", "voz": "es-MX-JorgeNeural"},
    {"n": "215", "id": "BioScan215", "voz": "es-ES-AlvaroNeural"},
    {"n": "216", "id": "BioScan216", "voz": "es-CL-LorenzoNeural"},
    {"n": "217", "id": "BioScan217", "voz": "es-CO-GonzaloNeural"},
    {"n": "218", "id": "BioScan218", "voz": "es-MX-JorgeNeural"},
    {"n": "219", "id": "BioScan219", "voz": "es-ES-AlvaroNeural"},
    {"n": "220", "id": "BioScan220", "voz": "es-CL-LorenzoNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch22.py")])
    if rc != 0:
...
log(f"\n=== BATCH 22 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 22 completo. Revisa D:\\500 videos bioscan\\")
