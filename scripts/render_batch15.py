"""
render_batch15.py -- Renderiza los 10 videos del Batch 15 (copies 141-150).
...
VIDEOS = [
    {"n": "141", "id": "BioScan141", "voz": "es-CO-GonzaloNeural"},
    {"n": "142", "id": "BioScan142", "voz": "es-MX-JorgeNeural"},
    {"n": "143", "id": "BioScan143", "voz": "es-ES-AlvaroNeural"},
    {"n": "144", "id": "BioScan144", "voz": "es-CL-LorenzoNeural"},
    {"n": "145", "id": "BioScan145", "voz": "es-CO-GonzaloNeural"},
    {"n": "146", "id": "BioScan146", "voz": "es-MX-JorgeNeural"},
    {"n": "147", "id": "BioScan147", "voz": "es-ES-AlvaroNeural"},
    {"n": "148", "id": "BioScan148", "voz": "es-CL-LorenzoNeural"},
    {"n": "149", "id": "BioScan149", "voz": "es-CO-GonzaloNeural"},
    {"n": "150", "id": "BioScan150", "voz": "es-MX-JorgeNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch15.py")])
    if rc != 0:
...
log(f"\n=== BATCH 15 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 15 completo. Revisa D:\\500 videos bioscan\\")
