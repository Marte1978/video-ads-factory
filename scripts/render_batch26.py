"""
render_batch26.py -- Renderiza los 10 videos del Batch 26 (copies 251-260).
...
VIDEOS = [
    {"n": "251", "id": "BioScan251", "voz": "es-ES-AlvaroNeural"},
    {"n": "252", "id": "BioScan252", "voz": "es-CL-LorenzoNeural"},
    {"n": "253", "id": "BioScan253", "voz": "es-CO-GonzaloNeural"},
    {"n": "254", "id": "BioScan254", "voz": "es-MX-JorgeNeural"},
    {"n": "255", "id": "BioScan255", "voz": "es-ES-AlvaroNeural"},
    {"n": "256", "id": "BioScan256", "voz": "es-CL-LorenzoNeural"},
    {"n": "257", "id": "BioScan257", "voz": "es-CO-GonzaloNeural"},
    {"n": "258", "id": "BioScan258", "voz": "es-MX-JorgeNeural"},
    {"n": "259", "id": "BioScan259", "voz": "es-ES-AlvaroNeural"},
    {"n": "260", "id": "BioScan260", "voz": "es-CL-LorenzoNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch26.py")])
    if rc != 0:
...
log(f"\n=== BATCH 26 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 26 completo. Revisa D:\\500 videos bioscan\\")
