"""
render_batch06.py -- Renderiza los 10 videos del Batch 06 (copies 051-060).
...
VIDEOS = [
    {"n": "051", "id": "BioScan051", "voz": "es-ES-AlvaroNeural"},
    {"n": "052", "id": "BioScan052", "voz": "es-CL-LorenzoNeural"},
    {"n": "053", "id": "BioScan053", "voz": "es-MX-JorgeNeural"},
    {"n": "054", "id": "BioScan054", "voz": "es-CO-GonzaloNeural"},
    {"n": "055", "id": "BioScan055", "voz": "es-ES-AlvaroNeural"},
    {"n": "056", "id": "BioScan056", "voz": "es-CL-LorenzoNeural"},
    {"n": "057", "id": "BioScan057", "voz": "es-MX-JorgeNeural"},
    {"n": "058", "id": "BioScan058", "voz": "es-CO-GonzaloNeural"},
    {"n": "059", "id": "BioScan059", "voz": "es-ES-AlvaroNeural"},
    {"n": "060", "id": "BioScan060", "voz": "es-CL-LorenzoNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch06.py")])
    if rc != 0:
...
log(f"\n=== BATCH 06 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 06 completo. Revisa D:\\500 videos bioscan\\")
