"""
render_batch10.py -- Renderiza los 10 videos del Batch 10 (copies 091-100).
...
VIDEOS = [
    {"n": "091", "id": "BioScan091", "voz": "es-ES-AlvaroNeural"},
    {"n": "092", "id": "BioScan092", "voz": "es-CL-LorenzoNeural"},
    {"n": "093", "id": "BioScan093", "voz": "es-CO-GonzaloNeural"},
    {"n": "094", "id": "BioScan094", "voz": "es-MX-JorgeNeural"},
    {"n": "095", "id": "BioScan095", "voz": "es-ES-AlvaroNeural"},
    {"n": "096", "id": "BioScan096", "voz": "es-CL-LorenzoNeural"},
    {"n": "097", "id": "BioScan097", "voz": "es-CO-GonzaloNeural"},
    {"n": "098", "id": "BioScan098", "voz": "es-MX-JorgeNeural"},
    {"n": "099", "id": "BioScan099", "voz": "es-ES-AlvaroNeural"},
    {"n": "100", "id": "BioScan100", "voz": "es-CL-LorenzoNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch10.py")])
    if rc != 0:
...
log(f"\n=== BATCH 10 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 10 completo. Revisa D:\\500 videos bioscan\\")
