"""
render_batch12.py -- Renderiza los 10 videos del Batch 12 (copies 111-120).
...
VIDEOS = [
    {"n": "111", "id": "BioScan111", "voz": "es-ES-AlvaroNeural"},
    {"n": "112", "id": "BioScan112", "voz": "es-CL-LorenzoNeural"},
    {"n": "113", "id": "BioScan113", "voz": "es-CO-GonzaloNeural"},
    {"n": "114", "id": "BioScan114", "voz": "es-MX-JorgeNeural"},
    {"n": "115", "id": "BioScan115", "voz": "es-ES-AlvaroNeural"},
    {"n": "116", "id": "BioScan116", "voz": "es-CL-LorenzoNeural"},
    {"n": "117", "id": "BioScan117", "voz": "es-CO-GonzaloNeural"},
    {"n": "118", "id": "BioScan118", "voz": "es-MX-JorgeNeural"},
    {"n": "119", "id": "BioScan119", "voz": "es-ES-AlvaroNeural"},
    {"n": "120", "id": "BioScan120", "voz": "es-CL-LorenzoNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch12.py")])
    if rc != 0:
...
log(f"\n=== BATCH 12 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 12 completo. Revisa D:\\500 videos bioscan\\")
