"""
render_batch20.py -- Renderiza los 10 videos del Batch 20 (copies 191-200).
...
VIDEOS = [
    {"n": "191", "id": "BioScan191", "voz": "es-ES-AlvaroNeural"},
    {"n": "192", "id": "BioScan192", "voz": "es-CL-LorenzoNeural"},
    {"n": "193", "id": "BioScan193", "voz": "es-CO-GonzaloNeural"},
    {"n": "194", "id": "BioScan194", "voz": "es-MX-JorgeNeural"},
    {"n": "195", "id": "BioScan195", "voz": "es-ES-AlvaroNeural"},
    {"n": "196", "id": "BioScan196", "voz": "es-CL-LorenzoNeural"},
    {"n": "197", "id": "BioScan197", "voz": "es-CO-GonzaloNeural"},
    {"n": "198", "id": "BioScan198", "voz": "es-MX-JorgeNeural"},
    {"n": "199", "id": "BioScan199", "voz": "es-ES-AlvaroNeural"},
    {"n": "200", "id": "BioScan200", "voz": "es-CL-LorenzoNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch20.py")])
    if rc != 0:
...
log(f"\n=== BATCH 20 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 20 completo. Revisa D:\\500 videos bioscan\\")
