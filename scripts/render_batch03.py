"""
render_batch03.py -- Renderiza los 10 videos del Batch 03 (copies 021-030).
...
VIDEOS = [
    {"n": "021", "id": "BioScan021", "voz": "es-MX-JorgeNeural"},
    {"n": "022", "id": "BioScan022", "voz": "es-CO-GonzaloNeural"},
    {"n": "023", "id": "BioScan023", "voz": "es-ES-AlvaroNeural"},
    {"n": "024", "id": "BioScan024", "voz": "es-CL-LorenzoNeural"},
    {"n": "025", "id": "BioScan025", "voz": "es-MX-JorgeNeural"},
    {"n": "026", "id": "BioScan026", "voz": "es-CO-GonzaloNeural"},
    {"n": "027", "id": "BioScan027", "voz": "es-ES-AlvaroNeural"},
    {"n": "028", "id": "BioScan028", "voz": "es-CL-LorenzoNeural"},
    {"n": "029", "id": "BioScan029", "voz": "es-MX-JorgeNeural"},
    {"n": "030", "id": "BioScan030", "voz": "es-CO-GonzaloNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch03.py")])
    if rc != 0:
...
log(f"\n=== BATCH 03 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 03 completo. Revisa D:\\500 videos bioscan\\")
