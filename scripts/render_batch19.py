"""
render_batch19.py -- Renderiza los 10 videos del Batch 19 (copies 181-190).
...
VIDEOS = [
    {"n": "181", "id": "BioScan181", "voz": "es-CO-GonzaloNeural"},
    {"n": "182", "id": "BioScan182", "voz": "es-MX-JorgeNeural"},
    {"n": "183", "id": "BioScan183", "voz": "es-ES-AlvaroNeural"},
    {"n": "184", "id": "BioScan184", "voz": "es-CL-LorenzoNeural"},
    {"n": "185", "id": "BioScan185", "voz": "es-CO-GonzaloNeural"},
    {"n": "186", "id": "BioScan186", "voz": "es-MX-JorgeNeural"},
    {"n": "187", "id": "BioScan187", "voz": "es-ES-AlvaroNeural"},
    {"n": "188", "id": "BioScan188", "voz": "es-CL-LorenzoNeural"},
    {"n": "189", "id": "BioScan189", "voz": "es-CO-GonzaloNeural"},
    {"n": "190", "id": "BioScan190", "voz": "es-MX-JorgeNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch19.py")])
    if rc != 0:
...
log(f"\n=== BATCH 19 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 19 completo. Revisa D:\\500 videos bioscan\\")
