"""
render_batch05.py -- Renderiza los 10 videos del Batch 05 (copies 041-050).
...
VIDEOS = [
    {"n": "041", "id": "BioScan041", "voz": "es-MX-JorgeNeural"},
    {"n": "042", "id": "BioScan042", "voz": "es-CO-GonzaloNeural"},
    {"n": "043", "id": "BioScan043", "voz": "es-ES-AlvaroNeural"},
    {"n": "044", "id": "BioScan044", "voz": "es-CL-LorenzoNeural"},
    {"n": "045", "id": "BioScan045", "voz": "es-MX-JorgeNeural"},
    {"n": "046", "id": "BioScan046", "voz": "es-CO-GonzaloNeural"},
    {"n": "047", "id": "BioScan047", "voz": "es-ES-AlvaroNeural"},
    {"n": "048", "id": "BioScan048", "voz": "es-CL-LorenzoNeural"},
    {"n": "049", "id": "BioScan049", "voz": "es-MX-JorgeNeural"},
    {"n": "050", "id": "BioScan050", "voz": "es-CO-GonzaloNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch05.py")])
    if rc != 0:
...
log(f"\n=== BATCH 05 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 05 completo. Revisa D:\\500 videos bioscan\\")
