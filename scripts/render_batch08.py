"""
render_batch08.py -- Renderiza los 10 videos del Batch 08 (copies 071-080).
...
VIDEOS = [
    {"n": "071", "id": "BioScan071", "voz": "es-CO-GonzaloNeural"},
    {"n": "072", "id": "BioScan072", "voz": "es-ES-AlvaroNeural"},
    {"n": "073", "id": "BioScan073", "voz": "es-CL-LorenzoNeural"},
    {"n": "074", "id": "BioScan074", "voz": "es-MX-JorgeNeural"},
    {"n": "075", "id": "BioScan075", "voz": "es-CO-GonzaloNeural"},
    {"n": "076", "id": "BioScan076", "voz": "es-ES-AlvaroNeural"},
    {"n": "077", "id": "BioScan077", "voz": "es-CL-LorenzoNeural"},
    {"n": "078", "id": "BioScan078", "voz": "es-MX-JorgeNeural"},
    {"n": "079", "id": "BioScan079", "voz": "es-CO-GonzaloNeural"},
    {"n": "080", "id": "BioScan080", "voz": "es-ES-AlvaroNeural"},
]
...
if missing:
    ...
    rc, _, err = run([sys.executable, str(BASE / "scripts" / "gen_tts_batch08.py")])
    if rc != 0:
...
log(f"\n=== BATCH 08 -- {datetime.now().strftime('%Y-%m-%d %H:%M')} ===")
...
print(f"\n[DONE] Batch 08 completo. Revisa D:\\500 videos bioscan\\")
