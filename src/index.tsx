...
import { batch26 } from './compositions/bioscan/batch26-data'
import { batch27 } from './compositions/bioscan/batch27-data'
import { batch28 } from './compositions/bioscan/batch28-data'
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      {/* ── Batch 19 — 500 Videos BioScan — Copies 181-190 ───────────────── */}
      {batch19.map((props, i) => {
      ...
      {/* ── Batch 20 — 500 Videos BioScan — Copies 191-200 ───────────────── */}
      {batch20.map((props, i) => {
      ...
      {/* ── Batch 21 — 500 Videos BioScan — Copies 201-210 ───────────────── */}
      {batch21.map((props, i) => {
      ...
      {/* ── Batch 22 — 500 Videos BioScan — Copies 211-220 ───────────────── */}
      {batch22.map((props, i) => {
      ...
      {/* ── Batch 23 — 500 Videos BioScan — Copies 221-230 ───────────────── */}
      {batch23.map((props, i) => {
      ...
      {/* ── Batch 24 — 500 Videos BioScan — Copies 231-240 ───────────────── */}
      {batch24.map((props, i) => {
      ...
      {/* ── Batch 25 — 500 Videos BioScan — Copies 241-250 ───────────────── */}
      {batch25.map((props, i) => {
      ...
      {/* ── Batch 26 — 500 Videos BioScan — Copies 251-260 ───────────────── */}
      {batch26.map((props, i) => {
        const n = String(i + 251).padStart(3, "0");
        return (
          <Composition
            key={`BioScan${n}`}
            id={`BioScan${n}`}
      ...
      {/* ── Batch 27 — 500 Videos BioScan — Copies 261-270 ───────────────── */}
      {batch27.map((props, i) => {
        const n = String(i + 261).padStart(3, "0");
        return (
          <Composition
            key={`BioScan${n}`}
            id={`BioScan${n}`}
      ...
      {/* ── Batch 28 — 500 Videos BioScan — Copies 271-280 ───────────────── */}
      {batch28.map((props, i) => {
        const n = String(i + 271).padStart(3, "0");
        return (
          <Composition
            key={`BioScan${n}`}
            id={`BioScan${n}`}
